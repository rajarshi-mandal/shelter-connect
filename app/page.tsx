      ...
      <section className="px-4 py-4 my-2">
        <div className="container mx-auto text-center max-w-4xl">
          ...
          <p className="text-xl text-muted-foreground text-pretty leading-relaxed mt-2.5 mb-2">
            ShelterConnect brings together homeless individuals, generous chefs, caring donors, and rescue animals across Massachusetts to build a stronger, more supportive community.
          </p>
      ...
      <section className="px-4 py-4 bg-[rgba(225,237,255,0.3)] my-0">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Homeless Shelter */}
            <Card className="hover:shadow-lg transition-shadow cursor-pointer group my-2">
              ...
              <CardContent className="pt-0">
                ...
                <Button className="w-full text-background bg-[rgba(0,92,57,1)]" size="lg" asChild>
                  <a href="/shelters">Find Resources</a>
                </Button>
              </CardContent>
            </Card>
            ...
            <Card className="hover:shadow-lg transition-shadow cursor-pointer group my-2">
              ...
              <CardContent className="pt-0">
                ...
                <Button className="w-full bg-[rgba(0,129,80,1)]" variant="secondary" size="lg" asChild>
                  <a href="/chef">Start Donating</a>
                </Button>
              </CardContent>
            </Card>
            ...
            <Card className="hover:shadow-lg transition-shadow cursor-pointer group my-2">
              ...
              <CardContent className="pt-0">
                ...
                <Button className="w-full text-background bg-[rgba(0,165,102,1)]" variant="outline" size="lg" asChild>
                  <a href="/donors">View Opportunities</a>
                </Button>
              </CardContent>
            </Card>
          </div>
